...
import { CalendarIcon, Edit3, Save, X, Copy, RefreshCw, Palette, Upload, Download } from "lucide-react";
...
const basicInfoSchema = z.object({
  eventTitle: z.string().min(1, "Event title is required").max(100, "Title too long"),
  eventSlug: z.string().min(1, "Event slug is required").regex(/^[a-z0-9-]+$/, "Invalid slug format"),
...
const BasicInfo = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (e: MouseEvent) => {
      if (pickerRef1.current && !pickerRef1.current.contains(e.target as Node)) {
        setShowColorPicker1(false);
      }
      if (pickerRef2.current && !pickerRef2.current.contains(e.target as Node)) {
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-6">
        <div>
          <CardTitle className="text-2xl font-bold">Event Basic Information</CardTitle>
        ...
        {!isEditing ? (
          ...
          <div className="space-y-4">
            ...
            <InfoRow 
              ...
              action={
                <Button variant="ghost" size="sm" onClick={copySlug} className="gap-1">
            ...
            <div>
              <Label className="text-sm font-semibold mb-2 block">Event Details</Label>
              <div 
                className="prose prose-sm max-w-none dark:prose-invert border rounded-md p-4 bg-muted/50"
                dangerouslySetInnerHTML={{ __html: eventDetails || "No details provided yet." }}
              />
            </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                />
                {errors.eventTitle && (
                  <p className="text-sm text-destructive">{errors.eventTitle.message}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                {errors.eventSlug && (
                  <p className="text-sm text-destructive">{errors.eventSlug.message}</p>
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                {errors.eventEndDate && (
                  <p className="text-sm text-destructive">{errors.eventEndDate.message}</p>
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                {errors.attendeeCount && (
                  <p className="text-sm text-destructive">{errors.attendeeCount.message}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.speakersCount && (
                  <p className="text-sm text-destructive">{errors.speakersCount.message}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.exhibitorsCount && (
                  <p className="text-sm text-destructive">{errors.exhibitorsCount.message}</p>
                )}
              </div>
            </div>
