...
const SponsorsProfile = () => {
  ...
  const [formData, setFormData] = useState({
    companyName: "",
    type: "sponsor" as "sponsor" | "exhibitor",
    facebook: "",
    instagram: "",
    twitter: "",
    linkedin: "",
                  ...
                  <div className="flex items-center space-x-6 mt-2">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={() => setFormData({...formData, type: "sponsor"})}
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={() => setFormData({...formData, type: "exhibitor"})}
                      />
              ...
              <TableBody>
                {sponsors.map((sponsor, index) => (
                  <TableRow key={sponsor.id}>
                    ...
                    <TableCell>
                      <Badge variant={sponsor.type === "sponsor" ? "default" : "secondary"}>
                        {sponsor.type}
                      </Badge>
                    </TableCell>
                    <TableCell>
