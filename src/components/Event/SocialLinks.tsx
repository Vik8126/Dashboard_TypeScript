...
const SocialLinks = () => {
  ...
  const socialPlatforms = [
    {
      name: "facebook" as keyof SocialLinksForm,
      label: "Facebook",
      placeholder: "https://facebook.com/yourpage",
      icon: Facebook,
    },
    {
      name: "instagram" as keyof SocialLinksForm,
      label: "Instagram",
      placeholder: "https://instagram.com/yourhandle",
      icon: Instagram,
    },
    {
      name: "linkedin" as keyof SocialLinksForm,
      label: "LinkedIn",
      placeholder: "https://linkedin.com/in/yourprofile",
      icon: Linkedin,
    },
    {
      name: "twitter" as keyof SocialLinksForm,
      label: "Twitter",
